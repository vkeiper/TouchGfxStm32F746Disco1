...
screenCanbusViewBase::screenCanbusViewBase()  :
    buttonCallback(this, &screenCanbusViewBase::buttonCallbackHandler)
{
    ...
    textAreaScreenData1.setTypedText(TypedText(T_SINGLEUSEID8));
    ...
    textAreaScreenName.setTypedText(TypedText(T_SINGLEUSEID6));
...
void screenCanbusViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &buttonHome)
    {
        //actionHomeBtn
    ...
    else if (&src == &buttonSettings)
    {
        ...
        //Go to SetTempControl with slide screen transition towards East
        application().gotoSetTempControlScreenSlideTransitionEast();
    }
}
